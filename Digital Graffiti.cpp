...
void solve()
{
    ...
    {
        bool ok=false;
        for(v99 j=0;j<m;j++) if(s[i][j]=='#'){p.insert({i,j});ok=true;break;}
        if(ok)break;
    }
    ...
    {
        bool ok=false;
        for(v99 i=0;i<n;i++) if(s[i][j]=='#'){p.insert({i,j});ok=true;break;}
        if(ok)break;
    }
    for(v99 j=0;j<m;j++) /// 3
    {
        bool ok=false;
        for(v99 i=n-1;~i;i--) if(s[i][j]=='#'){p.insert({i,j});ok=true;break;}
        if(ok)break;
    }
    ...
    {
        bool ok=false;
        for(v99 j=m-1;~j;j--) if(s[i][j]=='#'){p.insert({i,j});ok=true;break;}
        if(ok)break;
    }
