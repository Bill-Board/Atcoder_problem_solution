...
const v99 N=3000020;
v99 fact[N],inv[N],mod=1000000007LL;

void factorial()
{
    for(v99 i=0;i<2;i++)fact[i]=inv[i]=1LL;
    for(v99 i=2;i<N-10;i++)
    {
...
void solve()
{
    /// code is here->
    factorial();
    v99 r1,c1,r2,c2,cr_h=0;read(r1,c1,r2,c2);
    for(v99 c=c1;c<=c2;c++)cr_h+=(ncr(r2+c+1,c+1) - ncr(r1+c,c+1) +mod)%mod,cr_h%=mod;
    print(cr_h);
}
