...
{
    /// code is here->
    v99 n,r,mod=1000000007LL;read(r,n);
    if(r>n)return print(0);
    v99 sum_n=1;
    rep1(i,1,n)sum_n=(sum_n*i)%mod;
    v99 sum_r=1;
    rep1(i,1,r)sum_r=(sum_r*i)%mod;
    v99 sum_nr=1;
    rep1(i,1,n-r)sum_nr=(sum_nr*i)%mod;
    v99 inv_r=modularInverse(sum_r,mod);
    v99 n_r=modularInverse(sum_nr,mod);
    sum_n=(sum_n*n_r)%mod;
    print( (sum_n*inv_r)%mod );
